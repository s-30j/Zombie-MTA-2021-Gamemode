...
--		outputChatBox("#FF0000 Respawn LooT", root, 255, 255, 255, true);
--		refreshItemLoots()
	--setTimer(freezeElements, 5000, 1, true);
	--setTimer(refreshItemLoots, 17000, 1);

--end
--setTimer(refreshItemLootPoints,45000, 0);

--setTimer(refreshItemLootPoints, configVar.lootrespawn, 0);
