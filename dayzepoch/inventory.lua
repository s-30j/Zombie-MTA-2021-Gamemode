local inventoryItems = {
	...
	[7] = {
		...
		{"toolbelt9", 3,"images/inventory/carbody.png", "inventorydescription28", "inventoryactiontext24"},
	...
	[9] = {
		...
		--{"toolbelt9", 10,"images/inventory/carbody.png", "inventorydescription49"},
...
addEventHandler("onPlayerMoveItemOutOFInventory", root, function(itemName, loot)
	...
	if (itemName == "Body") then itemName2 = "toolbelt9"; end
...
addEventHandler("onClientGUIClick", resourceRoot, function()
	if (source == rwindow.channel[3]) then
		...
		setElementData(localPlayer, Type:lower().."gpschannel", channel);
...
function playerUseItem(itemName, itemInfo)
	...
	elseif (itemName == "toolbelt9") then triggerServerEvent("onPlayerCreateVeh", localPlayer, itemName);
	end
end
