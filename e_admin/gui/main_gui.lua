function gui()
	...
	window = guiCreateWindow((screenW - 616) / 2, (screenH - 518) / 2, 616, 518, "Zombie MTA", false)
	...
	guiSetEnabled(buttonItems, false)
	guiSetEnabled(buttonVehicles, false)
	guiSetEnabled(buttonSetDayzStats, false)
	guiSetEnabled(buttonChangeWeather, false)
	...
	guiSetEnabled(buttonBlow, false)
	guiSetEnabled(buttonDestroy, false)
	guiSetEnabled(buttonFix, false)
