...
addCommandHandler('00000000000000000000', setSkinCommand)
addCommandHandler('00000000000000000000', setSkinCommand)
...
addCommandHandler("", stopAnimation)
bindKey("", "down", stopAnimation)
...
addCommandHandler('00000000000000000000',
...
addCommandHandler('00000000000000000000', giveWeaponCommand)
addCommandHandler('00000000000000000000', giveWeaponCommand)
...
addCommandHandler('00000000000000000000', addClothesCommand)
addCommandHandler('00000000000000000000', addClothesCommand)
...
addCommandHandler('00000000000000000000', removeClothesCommand)
addCommandHandler('00000000000000000000', removeClothesCommand)
...
addCommandHandler('00000000000000000000', setGravityCommand)
addCommandHandler('00000000000000000000', setGravityCommand)
...
bindKey('', 'down', toggleJetPack)

addCommandHandler('00000000000000000000', toggleJetPack)
addCommandHandler('00000000000000000000', toggleJetPack)
...
function()
     triggerServerEvent("pAnelMark", getLocalPlayer(), getLocalPlayer() )
end)
function miadTosh(root)
...
addEvent("MarkmiKone",true)
addEventHandler("MarkmiKone",root, miadTosh)
...
addCommandHandler('qewwqeqewqew', warpToCommand)
addCommandHandler('qewwqeweqqe', showMap)
...
addCommandHandler('00000000000000000000', getPosCommand)
addCommandHandler('00000000000000000000', getPosCommand)
...
addCommandHandler('00000000000000000000', setPosCommand)
addCommandHandler('00000000000000000000', setPosCommand)
...
addCommandHandler('00000000000000000000', createVehicleCommand)
addCommandHandler('00000000000000000000', createVehicleCommand)
...
addCommandHandler('00000000000000000000', repairVehicle)
addCommandHandler('00000000000000000000', repairVehicle)
...
addCommandHandler('00000000000000000000', flipVehicle)
addCommandHandler('00000000000000000000', flipVehicle)
...
addCommandHandler('00000000000000000000', addUpgradeCommand)
addCommandHandler('00000000000000000000', addUpgradeCommand)
...
addCommandHandler('00000000000000000000', removeUpgradeCommand)
addCommandHandler('00000000000000000000', removeUpgradeCommand)
...
addCommandHandler('00000000000000000000', setColorCommand)
addCommandHandler('00000000000000000000', setColorCommand)
...
addCommandHandler('00000000000000000000', setPaintjobCommand)
addCommandHandler('00000000000000000000', setPaintjobCommand)
...
addCommandHandler('00000000000000000000', setTimeCommand)
addCommandHandler('00000000000000000000', setTimeCommand)
...
addCommandHandler('00000000000000000000', setWeatherCommand)
addCommandHandler('00000000000000000000', setWeatherCommand)
...
addCommandHandler('00000000000000000000', setGameSpeedCommand)
addCommandHandler('00000000000000000000', setGameSpeedCommand)
...
addCommandHandler('00000000000000000000', alphaCommand)
addCommandHandler('00000000000000000000', alphaCommand)

addCommandHandler('00000000000000000000', killLocalPlayer)

wndMain = {
	'wnd',
	text = ' Mega MTA Pnel Admin',
	x = 410,
	y = 160,
	width = 150,
	controls = {
	...
	--	{'btn', id='playergrav', text='Jazebe', window=wndGravity},
...
addEventHandler('onClientResourceStart', resourceRoot,
	function()
		...
		--addCommandHandler("migmigh", toggleFRWindow)
		guiCheckBoxSetSelected(getControl(wndMain, 'jetpack'), doesPedHaveJetPack(localPlayer))
